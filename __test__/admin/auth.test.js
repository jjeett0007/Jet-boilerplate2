...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Kaley_Schuster',
      password: 'tLyUm1LYvRFZcnW',
      email: 'Bettie.Weber@gmail.com',
      name: 'Dwayne Walter',
      userType: 802,
      mobileNo: '(151) 837-5843',
      resetPasswordLink: {},
      loginRetryLimit: 981,
      loginReactiveTime: '2024-06-02T22:46:36.176Z',
      id: '65959e7d55473f064173859b'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Maximo20',
        'password':'a8_mwF2_yAZC6wR',
        'email':'Dena53@yahoo.com',
        'name':'Rosemary Wisoky',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(883) 144-1681',
